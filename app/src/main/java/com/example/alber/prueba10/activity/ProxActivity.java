...
public class ProxActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url_consulta = "http://192.168.1.41:8080/prueba/consulusu.php?ins_sql=SELECT%20*%20FROM%20series%20WHERE%20FechaComienzo%20%3E%20CURDATE()";
    ...
    public void card(View view) {
        Intent intent = new Intent(ProxActivity.this, AnimeItem.class);
    ...
    class ObtenerDatos extends AsyncTask<String, String, JSONArray> {
        ...
        protected void onPreExecute() {
            pDialog = new ProgressDialog(ProxActivity.this);
        ...
        protected void onPostExecute(JSONArray json) {
            ...
            if (json != null) {
                ...
                Toast.makeText(ProxActivity.this, "JSON Array nulo", Toast.LENGTH_LONG).show();
            }
        }
    }
    ...
    private void probarConexion() {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            new ProxActivity.ObtenerDatos().execute();
        }
    }
}
