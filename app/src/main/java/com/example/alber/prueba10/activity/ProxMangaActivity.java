            ...
            if (json != null) {
                for (int i = 0; i < json.length(); i++) {
                    try {
                        ...
                        items.add(new Manga(jsonObject.getString("Imagen"), jsonObject.getInt("Nota"), jsonObject.getString("Nombre"), jsonObject.getString("Tipo"), jsonObject.getString("Estado"), jsonObject.getString("Capitulos"), jsonObject.getString("Volumenes"), jsonObject.getString("FechaComienzo")));
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                    recycler.setHasFixedSize(true);
